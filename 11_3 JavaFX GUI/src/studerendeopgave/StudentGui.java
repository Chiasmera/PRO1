...
public class StudentGui extends Application {
	...
	private void initContent(GridPane pane) {
		...
		pane.add(lblActive, 2, 3);

		pane.add(txfName, 1, 1, 4, 1);

		pane.add(chkActive, 3, 3);

		//Her starter min kode
		Label lblAge = new Label("Alder");
		pane.add(lblAge, 0,3);

		txfAge.setPrefWidth(10);
		pane.add(txfAge, 1,3);

		Button birthday = new Button("Birthday");
		pane.add(birthday, 1,4);
		birthday.setOnAction(event -> increaseAgeAction());
